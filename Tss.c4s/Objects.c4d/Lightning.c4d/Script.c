...
private func Advance()
{
  ...
  if (GBackSemiSolid(iVtxX-GetX(), iVtxY-GetY() ) && iVtxY-GetY() > LandscapeHeight()/2)
    return(Remove());
  ...
  var obj;
  //if (iVtx>1)
    if (obj = FindObject( 0, iVtxX-GetX()-75, iVtxY-GetY()-75, 150, 150, OCF_AttractLightning(), 0,0, NoContainer()  ) )
      Attraction(obj);
