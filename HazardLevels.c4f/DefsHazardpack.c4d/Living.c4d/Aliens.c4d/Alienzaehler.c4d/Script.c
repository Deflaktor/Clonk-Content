...
private Execute:
   ...
   while (SetVar(0, FindObject(_PLT,0,0,0,0,0, 0,0, 0, Var(0)) ))
     if(GetAlive(Var(0)))
       IncVar(1);
   SetVar(0,0);
   while (SetVar(0, FindObject(OZRK,0,0,0,0,0, 0,0, 0, Var(0)) ))
       IncVar(1);
   SetVar(0,0);
   while (SetVar(0, FindObject(_CHP,0,0,0,0,0, 0,0, 0, Var(0)) ))
       IncVar(1);
   SetVar(0,0);
   while (SetVar(0, FindObject(CGL2,0,0,0,0,0, 0,0, 0, Var(0)) ))
       IncVar(1);
   SetVar(0,0);
   while (SetVar(0, FindObject(SNKE,0,0,0,0,0, 0,0, 0, Var(0)) ))
     if(GetAlive(Var(0)))
       IncVar(1);
   SetVar(0,0);
  SetLocal(0,Var(1));
